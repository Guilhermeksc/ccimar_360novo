...
class CCIMAR15View(QMainWindow):
    teste = pyqtSignal()
    ...
    def setup_ui(self):
        ...
        self.label = QLabel("CCIMAR15 ", self)
        ...
        sub_label = QLabel("Patrimonial e de Atividades Especiais", self)
    ...
    def load_initial_content(self):
        ...
        initial_label = QLabel(" CCIMAR15", self.content_widget)
